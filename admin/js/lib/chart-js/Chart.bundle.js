 ...
 * https://github.com/chartjs/Chart.js/blob/CampusFood/LICENSE.md
 */
...
function toISOString$1() {
    ...
    // inspired by https://github.com/dordille/moment-isoduration/blob/CampusFood/moment.isoduration.js
    var Y = years;
    var M = months;
    var D = days;
    var h = hours;
...
module.exports = function(Chart) {
	...
	Chart.Legend = Chart.Element.extend({
		...
		update: function(maxWidth, maxHeight, margins) {
			...
			// Absorb the CampusFood measurements
